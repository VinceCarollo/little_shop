...
havarti = Item.create!(name: "Havarti", price: 68.99, image: 'https://cdn.shopify.com/s/files/1/2836/2982/products/Havarti-hero_grande.jpg?v=1529434186', inventory: 785, description: "Havarti or cream Havarti is a semisoft Danish cow's milk cheese. It is a table cheese that can be sliced, grilled, or melted.", user: merchant_2)
...
buyer_1_home = buyer_1.locations.create!(name: 'home', address: '1234 Test Dr', city: 'Denver', state: 'CO', zip: '80123')
buyer_2 = User.create!(email: 'buyer2@gmail.com', password: 'password', active: true, name: 'Christina Grater')
buyer_2_home = buyer_2.locations.create!(name: 'home', address: '1234 Test Dr', city: 'Kansas City', state: 'MO', zip: '80123')
buyer_3 = User.create!(email: 'buyer3@gmail.com', password: 'password', active: true, name: 'Jack Pepper')
buyer_3_home = buyer_3.locations.create!(name: 'home', address: '1234 Test Dr', city: 'Boston', state: 'MA', zip: '80123')
buyer_4 = User.create!(email: 'buyer4@gmail.com', password: 'password', active: true, name: 'Jason Munster')
buyer_4_home = buyer_4.locations.create!(name: 'home', address: '1234 Test Dr', city: 'Oakland', state: 'CA', zip: '80123')
buyer_5 = User.create!(email: 'buyer5@gmail.com', password: 'password', active: true, name: 'Linda Begood')
buyer_5_home = buyer_5.locations.create!(name: 'home', address: '1234 Test Dr', city: 'Los Angelos', state: 'CA', zip: '80123')

order_1 = Order.create!(user: buyer_1, status: 2, updated_at: DateTime.now + 10, location: buyer_1_home)
order_2 = Order.create!(user: buyer_2, status: 2, updated_at: DateTime.now + 20, location: buyer_2_home)
order_3 = Order.create!(user: buyer_3, status: 2, updated_at: DateTime.now + 30, location: buyer_3_home)
order_4 = Order.create!(user: buyer_4, status: 2, updated_at: DateTime.now + 40, location: buyer_4_home)
order_5 = Order.create!(user: buyer_5, status: 2, updated_at: DateTime.now + 50, location: buyer_5_home)
order_6 = Order.create!(user: buyer_1, status: 2, updated_at: DateTime.now + 60, location: buyer_1_home)
order_7 = Order.create!(user: buyer_2, status: 2, updated_at: DateTime.now + 70, location: buyer_2_home)
order_8 = Order.create!(user: buyer_3, status: 2, updated_at: DateTime.now + 70, location: buyer_3_home)
