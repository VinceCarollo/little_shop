Rails.application.routes.draw do
  ...
  scope module: :default, path: :profile do
    resources :orders, only: [:create, :show, :index, :destroy, :update], as: :profile_orders
  end
  ...
  scope module: 'merchants', path: 'dashboard', as: :dashboard do
    ...
    patch "coupons/:id/disable", to: "coupons#disable", as: :coupon_disable
    patch "coupons/:id/enable", to: "coupons#enable", as: :coupon_enable
  end
